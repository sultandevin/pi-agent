...
// Catppuccin Mocha palette — minimal pastel gradient
...
const PALETTE: Rgb[] = [MAUVE, LAVENDER, BLUE, SAPPHIRE, SKY, TEAL];
...
export default function (pi: ExtensionAPI) {
  ...
  pi.registerCommand("flow-title", {
    description: "Enable the Catppuccin pastel gradient session header",
